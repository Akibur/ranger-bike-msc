...
export default function Header() {
    ...
    const Dashboard = (
        <div className="hidden md:flex items-center   md:flex-1 lg:w-0">
            ...
            <button
                className="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-red-600 hover:bg-red-700" to="/home"
                onClick={logout}>
                Logout
            </button>
        </div>
