...
export default function MobileNav({ user }) {
    ...
    const Dashboard = (
        <div className="p-2">
            ...
            <NavLink
                className="w-full flex items-center justify-center px-4 py-2 my-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-red-600 hover:bg-red-700"
                to="/logout">
                Logout
            </NavLink>
        </div>
